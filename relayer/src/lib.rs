...
use winterfell::{ProofOptions, Prover, StarkProof, TraceTable};
use anyhow::{anyhow, Result};

// This includes the code generated by build.rs from the OUT_DIR environment variable.
include!(concat!(env!("OUT_DIR"), "/uibc_gen.rs"));

pub mod adapters;
pub mod zk;

pub use uibc_gen::uibc;
use uibc::v1::{UniversalMessage, ZkProof, ZkProofRequirement, Ics23Proof, ChainType, proof_requirement::Requirement};
use uibc::ibc::v1::IbcCompatibilityData;
...
use adapters::chain_adapter::InclusionProof;
